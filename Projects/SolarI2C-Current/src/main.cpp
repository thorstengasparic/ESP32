...
void GetSolarValues() 
{
  ...
  {
      double busvoltage = ina3221.getBusVoltage_V(BATTERY_CHANNEL);
      double shuntvoltage = ina3221.getShuntVoltage_mV(BATTERY_CHANNEL);
      BattaryCurrent = -ina3221.getCurrent_mA(BATTERY_CHANNEL);
      BattaryVoltage = busvoltage + (shuntvoltage / 1000);

      busvoltage = ina3221.getBusVoltage_V(LOAD_CHANNEL);
      shuntvoltage = ina3221.getShuntVoltage_mV(LOAD_CHANNEL);
      LoadCurrent = -ina3221.getCurrent_mA(LOAD_CHANNEL);
      LoadVoltage = busvoltage + (shuntvoltage / 1000);

      busvoltage = ina3221.getBusVoltage_V(SOLAR_CELL_CHANNEL);
      shuntvoltage = ina3221.getShuntVoltage_mV(SOLAR_CELL_CHANNEL);
